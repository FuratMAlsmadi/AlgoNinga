...
class AlrithmeticProgression(Progression):
    def __init__(self,increament = 1 ,start=0):
        super().__init__(start)
        self._increament = increament
    def _advance(self):
         self._current += self._increament
    def print_progression(self, n):
        return n//self._increament    
        

print(AlrithmeticProgression(128).print_progression(2**63))
